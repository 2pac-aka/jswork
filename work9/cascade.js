...
//     for (var i in data) {
//         var op = new Option(data[i],i); //创造下拉菜单中的option
...
// var majorSelect = document.getElementById('majorSelect');   //获取专业下拉菜单
// collegeSelect.onchange = function() {   //为学院下拉列表添加事件
//     majorSelect.options.length = 0;               //清空majors下的option
//     createOption(majorSelect,majors[collegeSelect.value]);
// };

// var classSelect = document.getElementById('classSelect');   //获取班级下拉菜单
// majorSelect.onchange = function () {   //为专业下拉列表添加事件
//     classSelect.options.length = 0;               //清空classes下的option
...
// createOption(majors,majorSelect[classSelect.value]);
// //以下是新增代码
